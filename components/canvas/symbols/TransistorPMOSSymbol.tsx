...
export const TransistorPMOSSymbol: React.FC<{ className?: string }> = ({ className }) => (
    <g stroke="currentColor" strokeWidth="2" fill="none" className={className}>
        ...
        {/* Substrate/Source Arrow Pointing IN for PMOS */}
        <path d="M-5,0 L5,0" />
        <path d="M0,-3 L-3,0 L0,3" fill="currentColor" stroke="none" />
    </g>
);